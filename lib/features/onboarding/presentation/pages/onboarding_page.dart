...
class _OnboardingPageState extends ConsumerState<OnboardingPage>
  ...
  final List<OnboardingItem> _onboardingItems = const [
    OnboardingItem(
      ...
      description:
          'File complaints in seconds with clear categories, details, and optional evidence.',
    ...
    OnboardingItem(
      title: 'Track Status',
      description:
          'Follow updates from submission to resolution and stay informed.',
    ...
    OnboardingItem(
      title: 'Get Support',
      description:
          'Reach the right department quickly for faster resolution.',
