...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> _categories = [
    ...
    {'name': 'Harassment', 'icon': Icons.gpp_bad_rounded},
  ...
  final List<Map<String, dynamic>> _items = [
    ...
    {
      'title': 'Harassment report follow-up',
                            ...
                            onTap: () {
                              AppRoutes.push(
                                ...
                                ItemDetailPage(
                                  ...
                                  isLost: item['isLost'],
                                  description:
                                      'This complaint is ${item['isLost'] ? 'open' : 'resolved'} at ${item['location']}. Please check for updates.',
                                  reportedBy: 'Softwarica Student',
                                ),
                              );
                            },
                          ),
